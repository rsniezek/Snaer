...
// configuration step. It creates a namespace called `Snaer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Snaer::cmake::project_name, Snaer::cmake::project_version) };
